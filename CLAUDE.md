...
Textual TUI, task queue, cron scheduler, web search, measurement rig. **559 offline tests**, green with no API key, no network, a
...
pytest                            # 559 tests, no API key, no network
```
