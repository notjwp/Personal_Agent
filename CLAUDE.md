...
Textual TUI, task queue, cron scheduler, email channel, web search, measurement rig. **1,145 offline tests**, green with no API key, no network, a
...
pytest                            # 1,145 tests, no API key, no network
```
