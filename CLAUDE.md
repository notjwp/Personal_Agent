...
Textual TUI, task queue, cron scheduler, web search, measurement rig. **595 offline tests**, green with no API key, no network, a
...
pytest                            # 595 tests, no API key, no network
```
