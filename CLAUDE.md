...
Textual TUI, task queue, cron scheduler, web search, measurement rig. **590 offline tests**, green with no API key, no network, a
...
pytest                            # 590 tests, no API key, no network
```
