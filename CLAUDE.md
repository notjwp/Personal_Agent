...
Textual TUI, task queue, cron scheduler, email channel, web search, measurement rig. **1,036 offline tests**, green with no API key, no network, a
...
pytest                            # 1,036 tests, no API key, no network
```
