...
Textual TUI, task queue, cron scheduler, email channel, web search, measurement rig. **720 offline tests**, green with no API key, no network, a
...
pytest                            # 720 tests, no API key, no network
```
