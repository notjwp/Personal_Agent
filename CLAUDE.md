...
Textual TUI, task queue, cron scheduler, email channel, web search, measurement rig. **1,041 offline tests**, green with no API key, no network, a
...
pytest                            # 1,041 tests, no API key, no network
```
